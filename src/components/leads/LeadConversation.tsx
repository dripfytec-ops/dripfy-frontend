    ...
    <div className="flex justify-end mb-3">
      <div className="max-w-xs">
        <div className="bg-primary text-white rounded-2xl rounded-tr-sm px-4 py-2.5 shadow-sm">
          ...
          <p className="text-sm">Template enviado</p>
          {message.erro_msg && (
            <p className="text-xs mt-1 text-red-200">{message.erro_msg}</p>
          )}
        </div>
    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-white flex flex-col h-full shadow-2xl">
        ...
        <div className="border-t border-slate-200 px-4 py-3 bg-white">
          ...
          <p className="text-xs text-slate-300 mt-1">Atualiza automaticamente a cada 10s</p>
        </div>
      </div>
    </div>
  );
